...
urlpatterns = [
    ...
    path("export-csv-report/", export_csv_report, name="export_csv_report"),
    path("performance-report/", performance_report, name="performance_report"),
    path("face-attendance/", face_attendance_page, name="face_attendance"),
    path("start-face-attendance/", start_face_attendance, name="start_face_attendance"),
    path("process-face-attendance/", process_face_attendance, name="process_face_attendance"),
