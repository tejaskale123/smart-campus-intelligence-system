...
def analytics_view(request):
    ...
    # TODAY ATTENDANCE
    # =========================
    present_students = attendance_collection.count_documents({
        "status": "Present"
    })

    absent_students = attendance_collection.count_documents({
        "status": "Absent"
    })
...
total_attendance = present_students + absent_students

attendance_percentage = (
    round((present_students / total_attendance) * 100, 2)
    ...
    # COURSE DISTRIBUTION
    # =========================
    bca_count = students_collection.count_documents({"course": "BCA"})
    mca_count = students_collection.count_documents({"course": "MCA"})
    btech_count = students_collection.count_documents({"course": "B.Tech"})
    bcom_count = students_collection.count_documents({"course": "B.Com"})
